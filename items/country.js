'use strict';
const COUNTRY_LIST = [{"code": "AD", "name": "Andorra"}, {"code": "AE", "name": "United Arab Emirates"}, {
  "code": "AF",
  "name": "Afghanistan"
  ...
  "code": "AT",
  "name": "Austria"
}, {"code": "AU", "name": "Australia"}, {"code": "AW", "name": "Aruba"}, {"code": "AX", "name": "Åland"}, {
  "code": "AZ",
  "name": "Azerbaijan"
  ...
  "code": "BO",
  "name": "Bolivia"
}, {"code": "BQ", "name": "Bonaire"}, {"code": "BR", "name": "Brazil"}, {
  "code": "BS",
  "name": "Bahamas"
...
}, {"code": "CG", "name": "Republic of the Congo"}, {"code": "CH", "name": "Switzerland"}, {
  "code": "CI",
  "name": "Ivory Coast"
  ...
  "code": "MK",
  "name": "Macedonia"
}, {"code": "ML", "name": "Mali"}, {"code": "MM", "name": "Myanmar [Burma]"}, {
  "code": "MN",
  "name": "Mongolia"
  ...
  "code": "TJ",
  "name": "Tajikistan"
}, {"code": "TK", "name": "Tokelau"}, {"code": "TL", "name": "East Timor"}, {
  "code": "TM",
  "name": "Turkmenistan"
...
const COUNTRY_MAP = {};
for (let i = 0, len = COUNTRY_LIST.length; i < len; i++) {
  COUNTRY_MAP[COUNTRY_LIST[i].code] = COUNTRY_LIST[i].name;
}
/**
 * Country validator for ISO-ALPHA-2 Code
 */
module.exports = (IFace) => {
  return class SanitizeCountry extends IFace {
    static code() {
      return "COUNTRY"
    };
